...
struct DisplayGeometryTests {
    ...
    @Test func anchorGeometryUsesHardwareNotchWhenAvailable() {
        ...
        #expect(geometry.hoverHintFrame.height == 88)
        #expect(geometry.hoverHintFrame.maxY == profile.frame.maxY + 16)
        ...
        #expect(geometry.expandedFrame.height == 328)
        #expect(geometry.expandedFrame.maxY == profile.frame.maxY + 16)
